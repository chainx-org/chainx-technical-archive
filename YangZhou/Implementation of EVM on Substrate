...
![img](file:////tmp/wps-liucz/ksohtml/wpsnevNUX.jpg) 

Main parts of EVM：

![img](file:////tmp/wps-liucz/ksohtml/wpse9ajLW.jpg) 
...
Machine State is where evm code is executed, contains program counter, stack, memory.
